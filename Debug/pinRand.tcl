#============================================================
# DEFINE PROJECT NAME !!!!!!!!!!!!!
#set proj_name - for Debug lab
# file for testing the Random macine 
...
set_location_assignment PIN_AK4 -to rise ;#KEY[1]
...
set_location_assignment PIN_AB23 -to dout[0] ;#LEDR[1]
set_location_assignment PIN_AC23 -to dout[1] ;#LEDR[2]
set_location_assignment PIN_AD24 -to dout[2] ;#LEDR[3]
set_location_assignment PIN_AG25 -to dout[3] ;#LEDR[4]
set_location_assignment PIN_AF25 -to dout[4] ;#LEDR[5]
set_location_assignment PIN_AE24 -to dout[5] ;#LEDR[6]
set_location_assignment PIN_AF24 -to dout[6] ;#LEDR[7]
set_location_assignment PIN_AB22 -to dout[7] ;#LEDR[8]
