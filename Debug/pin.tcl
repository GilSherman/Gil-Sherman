...
set_location_assignment PIN_AB23 -to keyToggle ;#LEDR[1]
set_location_assignment PIN_AC23 -to keyPadValid ;#LEDR[2]
...
set_location_assignment PIN_AB22 -to dataIn ;#LEDR[8]
